...
export default merge(baseTheme, {
  ...
  sizes: {
    ...
    mainMarginTop: "200px", // Makes sure the content comes below the fixed header, should be the same values as headerHeight
    mainMarginTopTablet: "200px", // Makes sure the content comes below the fixed header, should be the same values as headerHeight
    mainMarginTopLaptop: "200px", // Makes sure the content comes below the fixed header, should be the same values as headerHeight
  },
  catalystOptions: {
